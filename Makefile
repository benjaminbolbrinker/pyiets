...
H2O_ridft_tm_params=./tests/H2O_ridft_tm_params
...
clean_H2O_ridft_tm_params:
	rm -rf ${H2O_ridft_tm_params}/*distortions* ${H2O_ridft_tm_params}/*.restart ${H2O_ridft_tm_params}/output 
